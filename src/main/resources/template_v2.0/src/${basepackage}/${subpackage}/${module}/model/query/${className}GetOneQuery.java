...
public class ${className}GetOneQuery implements Serializable
{
...
<#list table.compositeIdColumns as column>
	...
	{
		return "${className}GetOneQuery [dynamicColumns=" + Arrays.toString(dynamicColumns) + <#list table.compositeIdColumns as column>", ${column.columnNameLower}=" + ${column.columnNameLower}</#list> + "]";
	}
}
