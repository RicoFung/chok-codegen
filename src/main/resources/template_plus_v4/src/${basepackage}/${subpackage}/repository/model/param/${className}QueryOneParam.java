...
public class ${className}QueryOneParam implements Serializable 
{
    ...
    public ${className}QueryOneParam by${column.columnName}(${column.javaType} ${column.columnNameLower}) 
    {
	...
	public ${className}QueryOneParam setDynamicWhere(DynamicWhere dynamicWhere)
	{
	...
	public ${className}QueryOneParam setDynamicColumns(String[] dynamicColumns)
	{
